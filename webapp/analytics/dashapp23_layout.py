"""
Дашборд для анализа качественных показателей по группе
"""
...
filter_kf = dcc.Dropdown(   
  options = [
   {'label':'Сторона поражения', 'value':'Сторона поражения'},
   {'label':'ASA', 'value':'ASA'},
   {'label':'Количество операций', 'value':'Количество операций'},
   {'label':'Количество пациентов прошедших по этапам обследования', 'value':'Количество пациентов прошедших по этапам обследования'},
  ],
  value='Сторона поражения',
  multi=False,  
